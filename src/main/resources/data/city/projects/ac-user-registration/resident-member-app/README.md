# ac-worker-app (namespace: ac-user-registration)
...
- `$ pnpm run mock-server` to run mock-server of backend
  - It serves the app at `http://localhost:3000/resident-member/`
...
- Bundle
  - `$ bazel build //projects/ac-user-registration/resident-member-app:bundle`
- Run the app with serve
  - `$ bazel run //projects/ac-user-registration/resident-member-app:serve --define mode=dev`
- Run ESLint
  - `$ bazel test //projects/ac-user-registration/resident-member-app:lint-test`
- Run the app with nginx docker container
  - `$ bazel run //projects/ac-user-registration/resident-member-app`
