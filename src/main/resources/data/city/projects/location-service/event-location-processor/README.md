# Event Location Processor

The Event Location Processor microservice is a part of Location Service and is responsible for:

* Consuming protobuf event location data from event input Kafka
* Deserializing the event location data
...
```
bazel build //projects/location-service/event-location-processor/cmd/event-location-processor
```
...
```
bazel build //projects/location-service/event-location-processor/cmd/event-location-processor --platforms=@io_bazel_rules_go//go/toolchain:linux_amd64 
```
...
```
bazel run //projects/location-service/event-location-processor/cmd/event-location-processor:event-location-processor.binary
```
