...
## Sources
  - cluster.json, control-plane.json, logs.json:
    - [flux2 on Github v2.1.2](https://github.com/fluxcd/flux2/tree/9b3162495ce1b99b1fcdf137c553f543eafe3ec7/manifests/monitoring/monitoring-config/dashboards)
  - dashboard.json, logs.json, reconcile-timeline.json:
    - in-house

Update 2022-11-21: Update to v2.1.2
